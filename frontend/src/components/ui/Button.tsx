...
const VARIANTS: Record<ButtonVariant, string> = {
  primary:
    'bg-accent-500 text-on-accent shadow-[0_1px_0_0_rgba(255,255,255,0.22)_inset] hover:bg-accent-400 active:bg-accent-600',
  ...
  // Pale fill, so the lettering is the dark token rather than on-accent.
  success: 'bg-emerald-400 text-on-bright hover:bg-emerald-300 active:bg-emerald-500',
};
